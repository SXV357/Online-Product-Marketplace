 ...
 * Each Dashboard will return an arraylist with three collumns: Name, Total quantity, Total revenue
...
public class Dashboard {
    ...
    public static ArrayList<String> sellerGetProductsDashboard(int sortIndex, boolean sortDescending){
        ...
        for (String product:allProducts){
            ...
            //get all purchases this customer has made, productID on 3rd index of purchasHistories
    ...
    public static ArrayList<String> customerGetStoresDashboard(int sortIndex, boolean sortDescending){
        ...
        for (String store:allStores){
            ...
            //Store name is stored in the 4th collumn
            String storeName = storeDataList[4];
            //Add customer's stats to the list
            //Format: email, totalQuantity, totalSpent
