...
public class CustomerTest {
    ...
    public static void testAddToCart(Customer c, Database db) {
        ...
        c.addToCart(2, 100);
        assertEquals("Add To Cart Error", "C100001,S100001,ST100001,PR100002,myStore,mySecondProduct,100,100000.0",
    ...
    public static void testPurchaseItems(Customer c, Database db) {
        ...
        assertEquals("Update Purchase History Error", "C100001,S100001,ST100001,PR100001,myStore,myProduct,20,500.0",
